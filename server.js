// Hey Bori — Stable Non-Streaming (zero deps)
// Uses Node's built-in https and serves a chat UI (no inner backticks).
...
// ---------- HTML UI (no backticks inside <script>) ----------
...
<footer>© Bori Labs LLC — Let’s Go Pa’lante 🏀 • Build: core-https-nobt</footer>\
<script>\
...
console.log('✅ Hey Bori (core-https-nobt) listening on ' + PORT);
});
